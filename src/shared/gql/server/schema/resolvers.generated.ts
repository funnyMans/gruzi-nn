...
import    { Truck } from './trucks/resolvers/Truck';
    export const resolvers: Resolvers = {
      Query: { broker: Query_broker,brokers: Query_brokers,driver: Query_driver,drivers: Query_drivers,privacyPolicy: Query_privacyPolicy,shipment: Query_shipment,shipments: Query_shipments,termsOfUse: Query_termsOfUse,truck: Query_truck,trucks: Query_trucks },
      Mutation: { addTrackingUpdate: Mutation_addTrackingUpdate,createBroker: Mutation_createBroker,createPrivacyPolicy: Mutation_createPrivacyPolicy,createShipment: Mutation_createShipment,createTermsOfUse: Mutation_createTermsOfUse,updateBroker: Mutation_updateBroker,updatePrivacyPolicy: Mutation_updatePrivacyPolicy,updateShipmentStatus: Mutation_updateShipmentStatus,updateTermsOfUse: Mutation_updateTermsOfUse },
